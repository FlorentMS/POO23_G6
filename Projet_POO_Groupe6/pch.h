// pch.h : Il s'agit d'un fichier d'entête précompilé.
// Les fichiers listés cidessous sont compilés une seule fois, ce qui améliore les performances de génération des futures builds.
...
// ajouter les entêtes à précompiler ici
